			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0">Omar Adel</h4>
							<span class="mb-0 text-muted"> oadel6834@gmail.com</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">قائمه الفواتير</a></li>
					

							
							<li><a class="slide-item" href="{{ url('/' . $page='invoice_paid') }}"> الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='invoice_unPaid') }}"> الفواتير غير مدفوعه</a></li>

							
						

							<li><a class="slide-item" href="{{ url('/' . $page='invoice_partail') }}">الفواتير مدفوعه جزئيه</a></li>
